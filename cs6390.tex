...
\textbf{Usages}: For multivariate distributions, generate data, compute probability of a configuration, infer the most probable value, learn parameters of a distribution given samples.
